...
import { CHUNK } from '../world/world.js?v=mrs9orgs';
import { elencoLuci, statLuci, statImpatti, memoriaVoxel } from '../fx/materials.js?v=mrs9orgs';
import { FISICA } from '../config.js?v=mrs9orgs';
