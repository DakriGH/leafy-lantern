...
import { CHUNK } from '../world/world.js?v=ms2yheag';
import { elencoLuci, statLuci, statImpatti, memoriaVoxel } from '../fx/materials.js?v=ms2yheag';
import { FISICA } from '../config.js?v=ms2yheag';
