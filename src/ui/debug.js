...
import { CHUNK } from '../world/world.js?v=ms3kbelx';
import { elencoLuci, statLuci, statImpatti, memoriaVoxel } from '../fx/materials.js?v=ms3kbelx';
import { FISICA } from '../config.js?v=ms3kbelx';
