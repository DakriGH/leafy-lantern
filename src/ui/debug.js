...
import { CHUNK } from '../world/world.js?v=ms2ghfs8';
import { elencoLuci, statLuci, statImpatti, memoriaVoxel } from '../fx/materials.js?v=ms2ghfs8';
import { FISICA } from '../config.js?v=ms2ghfs8';
