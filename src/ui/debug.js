...
import { CHUNK } from '../world/world.js?v=mtbir7zv';
import { elencoLuci, statLuci, statImpatti, memoriaVoxel } from '../fx/materials.js?v=mtbir7zv';
import { FISICA } from '../config.js?v=mtbir7zv';
