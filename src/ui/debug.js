...
import { CHUNK } from '../world/world.js?v=mrsenxmm';
import { elencoLuci, statLuci, statImpatti, memoriaVoxel } from '../fx/materials.js?v=mrsenxmm';
import { FISICA } from '../config.js?v=mrsenxmm';
