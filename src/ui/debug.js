...
import { CHUNK } from '../world/world.js?v=ms3nnu1r';
import { elencoLuci, statLuci, statImpatti, memoriaVoxel } from '../fx/materials.js?v=ms3nnu1r';
import { FISICA } from '../config.js?v=ms3nnu1r';
