...
import { CHUNK } from '../world/world.js?v=ms3d2i50';
import { elencoLuci, statLuci, statImpatti, memoriaVoxel } from '../fx/materials.js?v=ms3d2i50';
import { FISICA } from '../config.js?v=ms3d2i50';
