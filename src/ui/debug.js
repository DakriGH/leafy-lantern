...
import { CHUNK } from '../world/world.js?v=ms2y1d0v';
import { elencoLuci, statLuci, statImpatti, memoriaVoxel } from '../fx/materials.js?v=ms2y1d0v';
import { FISICA } from '../config.js?v=ms2y1d0v';
