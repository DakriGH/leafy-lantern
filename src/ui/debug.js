...
import { CHUNK } from '../world/world.js?v=ms28fhvp';
import { elencoLuci, statLuci, statImpatti, memoriaVoxel } from '../fx/materials.js?v=ms28fhvp';
import { FISICA } from '../config.js?v=ms28fhvp';
