...
import { CHUNK } from '../world/world.js?v=mtbqffyn';
import { elencoLuci, statLuci, statImpatti, memoriaVoxel } from '../fx/materials.js?v=mtbqffyn';
import { FISICA } from '../config.js?v=mtbqffyn';
