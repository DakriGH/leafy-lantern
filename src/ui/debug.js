...
import { CHUNK } from '../world/world.js?v=mtblppo3';
import { elencoLuci, statLuci, statImpatti, memoriaVoxel } from '../fx/materials.js?v=mtblppo3';
import { FISICA } from '../config.js?v=mtblppo3';
