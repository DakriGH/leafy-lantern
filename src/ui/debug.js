...
import { CHUNK } from '../world/world.js?v=mtbifcbo';
import { elencoLuci, statLuci, statImpatti, memoriaVoxel } from '../fx/materials.js?v=mtbifcbo';
import { FISICA } from '../config.js?v=mtbifcbo';
