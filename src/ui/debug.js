...
import { CHUNK } from '../world/world.js?v=mrsh3dhg';
import { elencoLuci, statLuci, statImpatti, memoriaVoxel } from '../fx/materials.js?v=mrsh3dhg';
import { FISICA } from '../config.js?v=mrsh3dhg';
