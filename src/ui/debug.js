...
import { CHUNK } from '../world/world.js?v=mrsf4ny9';
import { elencoLuci, statLuci, statImpatti, memoriaVoxel } from '../fx/materials.js?v=mrsf4ny9';
import { FISICA } from '../config.js?v=mrsf4ny9';
