...
import { CHUNK } from '../world/world.js?v=ms2xhyng';
import { elencoLuci, statLuci, statImpatti, memoriaVoxel } from '../fx/materials.js?v=ms2xhyng';
import { FISICA } from '../config.js?v=ms2xhyng';
