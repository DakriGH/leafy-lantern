...
import { CHUNK } from '../world/world.js?v=mtavryo3';
import { elencoLuci, statLuci, statImpatti, memoriaVoxel } from '../fx/materials.js?v=mtavryo3';
import { FISICA } from '../config.js?v=mtavryo3';
