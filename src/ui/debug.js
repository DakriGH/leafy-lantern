...
import { CHUNK } from '../world/world.js?v=ms3ci6d9';
import { elencoLuci, statLuci, statImpatti, memoriaVoxel } from '../fx/materials.js?v=ms3ci6d9';
import { FISICA } from '../config.js?v=ms3ci6d9';
