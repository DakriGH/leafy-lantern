...
import { CHUNK } from '../world/world.js?v=ms2xo6kx';
import { elencoLuci, statLuci, statImpatti, memoriaVoxel } from '../fx/materials.js?v=ms2xo6kx';
import { FISICA } from '../config.js?v=ms2xo6kx';
