...
import { PX, RAGGIO_CLICK, ACQUA, NET, SCAVO } from './config.js?v=ms258m6h';
import { Rig } from './engine/renderer.js?v=ms258m6h';
import { Input } from './engine/input.js?v=ms258m6h';
import { raggioGriglia, raggioDaSchermo } from './engine/raycast.js?v=ms258m6h';
import { Cadenza } from './engine/cadenza.js?v=ms258m6h';
import { GpuProfiler, Campioni } from './engine/gpuTimer.js?v=ms258m6h';
import { componiDiagnostica } from './engine/diagnostica.js?v=ms258m6h';
import { BLOCCHI, CATEGORIE_BLOCCHI, defDi, tipoBase, livelloAcqua } from './world/blocks.js?v=ms258m6h';
import { Mondo } from './world/world.js?v=ms258m6h';
import { SimAcqua } from './world/acqua.js?v=ms258m6h';
import { Lobby } from './net/lobby.js?v=ms258m6h';
import { Segnalatore } from './net/segnalatore.js?v=ms258m6h';
import { Bolla } from './ui/bolla.js?v=ms258m6h';
import { Scelta } from './ui/scelta.js?v=ms258m6h';
import { Bersaglio, POSE } from './gioco/bersaglio.js?v=ms258m6h';
import { Zaino } from './ui/zaino.js?v=ms258m6h';
import { Mesher, geometriaSingola } from './world/mesher.js?v=ms258m6h';
import { generaIsola, generaArcipelago, generaOpenWorld, SPAWN, ARREDO_INIZIALE } from './world/worldgen.js?v=ms258m6h';
import { generaMostra } from './world/mostra.js?v=ms258m6h';
import { generaCollaudo } from './world/collaudo.js?v=ms258m6h';
import { generaTestLuci } from './world/testLuci.js?v=ms258m6h';
import { generaTestMacchine } from './world/testMacchine.js?v=ms258m6h';
import { FuochiFatui } from './fx/fuochiFatui.js?v=ms258m6h';
import { STAGIONI, impostaStagione, stagioneCorrente, ritingiFogliame, avviaTransizione, aggiornaTransizione } from './world/stagioni.js?v=ms258m6h';
import { Meteo } from './fx/meteo.js?v=ms258m6h';
import { Inventario, ATTREZZI } from './gioco/inventario.js?v=ms258m6h';
import { Tavolozza, ZAMPA } from './gioco/tavolozza.js?v=ms258m6h';
import { StriscaTavolozza } from './ui/tavolozza.js?v=ms258m6h';
import { Scavo, DUREZZE } from './gioco/scavo.js?v=ms258m6h';
import { CicloGiorno } from './fx/daynight.js?v=ms258m6h';
import { aggiornaLuci, aggiornaTempo, impostaPioggia, impostaRiflesso, impostaOmbrePg, impostaForzaRiflesso, impostaSchiumaAcqua, impostaSchiumaTop, creaLuce, creaLuceLeggera, spostaLuce, rimuoviLuce, impostaOcclusione, uniformiCondivise, impostaLatoMassimoVoxel, memoriaVoxel, statLuci } from './fx/materials.js?v=ms258m6h';
import { SchiumaTop, LAYER_SCHIUMA } from './fx/schiumaTop.js?v=ms258m6h';
import { ModalitaAR } from './ar/ar.js?v=ms258m6h';
import { Nuvole } from './fx/nuvole.js?v=ms258m6h';
import { SegnaPercorso } from './fx/percorso.js?v=ms258m6h';
import { ComandiTouch } from './ui/comandi-touch.js?v=ms258m6h';
import { RiflessoAcqua } from './fx/riflesso.js?v=ms258m6h';
import { Pioggia } from './fx/pioggia.js?v=ms258m6h';
import { Particelle } from './fx/particelle.js?v=ms258m6h';
import { Audio } from './fx/audio.js?v=ms258m6h';
import { Creature, registraComponentiCreature, sistemaCreature, pensaCreatura } from './gioco/creature.js?v=ms258m6h';
import { RICETTE, puoiCraftare, crafta } from './gioco/craft.js?v=ms258m6h';
import { registraComponentiPalle, creaEntitaPalla, distruggiPalla, calciaPalla, sistemaPalle, sistemaResaPalle } from './gioco/palla.js?v=ms258m6h';
import { registraComponentiMacchine, GestoreMacchine, guidaMacchina, toccaMacchina, macchinaDi, haPannello } from './gioco/macchine.js?v=ms258m6h';
import { PannelloMacchina } from './ui/pannelloMacchina.js?v=ms258m6h';
import { Registro } from './ecs/registro.js?v=ms258m6h';
import { Orologio, Rng } from './ecs/orologio.js?v=ms258m6h';
import { Sistemi } from './ecs/sistemi.js?v=ms258m6h';
import { Agenda } from './ecs/agenda.js?v=ms258m6h';
import { Gatto } from './player/player.js?v=ms258m6h';
import { ManoStrumento } from './player/mano.js?v=ms258m6h';
import { dropDi } from './gioco/drop.js?v=ms258m6h';
import { Controller } from './player/controller.js?v=ms258m6h';
import { FURNI, centroide } from './furniture/registry.js?v=ms258m6h';
import { caricaModelli } from './furniture/loader.js?v=ms258m6h';
import { Arredo } from './furniture/furniture.js?v=ms258m6h';
import { HUD } from './ui/hud.js?v=ms258m6h';
import { MenuDebug } from './ui/debug.js?v=ms258m6h';
import { Officina, caricaOfficina, registraDaRete, rimuoviDaRete } from './ui/officina.js?v=ms258m6h';
import { ModalitaXR } from './ar/ar-xr.js?v=ms258m6h';
import { serializza, applica, salvaLocale, caricaLocale, cancellaLocale, esportaFile, elencoSlot, salvaSlot, caricaSlot, rinominaSlot, cancellaSlot } from './save.js?v=ms258m6h';
