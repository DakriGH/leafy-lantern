...
import { PX, RAGGIO_CLICK, ACQUA, NET, SCAVO, ANALITICA_URL, CHIAVE_SALVATAGGIO, CAMERA } from './config.js?v=mtbzxc5q';
import { Rig } from './engine/renderer.js?v=mtbzxc5q';
import { Input } from './engine/input.js?v=mtbzxc5q';
import { raggioGriglia, raggioDaSchermo } from './engine/raycast.js?v=mtbzxc5q';
import { Cadenza } from './engine/cadenza.js?v=mtbzxc5q';
import { GpuProfiler } from './engine/gpuTimer.js?v=mtbzxc5q';
import { creaBatteria } from './engine/batteria.js?v=mtbzxc5q';
import { BLOCCHI, CATEGORIE_BLOCCHI, defDi, tipoBase, livelloAcqua } from './world/blocks.js?v=mtbzxc5q';
import { Mondo } from './world/world.js?v=mtbzxc5q';
import { SimAcqua } from './world/acqua.js?v=mtbzxc5q';
import { Lobby } from './net/lobby.js?v=mtbzxc5q';
import { Segnalatore } from './net/segnalatore.js?v=mtbzxc5q';
import { avviaAnalitica, urlPannello } from './net/analitica.js?v=mtbzxc5q';
import { puo as ruoloPuo, DESCRIZIONE as RUOLO_DESCR, RUOLI } from './net/permessi.js?v=mtbzxc5q';
import { leggiProfilo, salvaProfilo, COLORI as COLORI_PROFILO } from './net/profilo.js?v=mtbzxc5q';
import { PannelloInsieme } from './ui/multiplayer.js?v=mtbzxc5q';
import { Targhetta } from './ui/targhetta.js?v=mtbzxc5q';
import { Bolla } from './ui/bolla.js?v=mtbzxc5q';
import { Scelta } from './ui/scelta.js?v=mtbzxc5q';
import { Bersaglio, POSE } from './gioco/bersaglio.js?v=mtbzxc5q';
import { Zaino } from './ui/zaino.js?v=mtbzxc5q';
import { Mesher, geometriaSingola } from './world/mesher.js?v=mtbzxc5q';
import { generaIsola, generaArcipelago, generaOpenWorld, generaMondoGigante, SPAWN, ARREDO_INIZIALE } from './world/worldgen.js?v=mtbzxc5q';
import { generaMostra } from './world/mostra.js?v=mtbzxc5q';
import { generaCollaudo } from './world/collaudo.js?v=mtbzxc5q';
import { generaTestLuci } from './world/testLuci.js?v=mtbzxc5q';
import { generaBancoOmbre } from './world/bancoOmbre.js?v=mtbzxc5q';
import { generaTestMacchine } from './world/testMacchine.js?v=mtbzxc5q';
import { generaZoo } from './world/zoo.js?v=mtbzxc5q';
import { FuochiFatui } from './fx/fuochiFatui.js?v=mtbzxc5q';
import { STAGIONI, impostaStagione, stagioneCorrente, ritingiFogliame, avviaTransizione, aggiornaTransizione } from './world/stagioni.js?v=mtbzxc5q';
import { Meteo } from './fx/meteo.js?v=mtbzxc5q';
import { Inventario, ATTREZZI } from './gioco/inventario.js?v=mtbzxc5q';
import { Tavolozza, ZAMPA } from './gioco/tavolozza.js?v=mtbzxc5q';
import { StriscaTavolozza } from './ui/tavolozza.js?v=mtbzxc5q';
import { Scavo, DUREZZE } from './gioco/scavo.js?v=mtbzxc5q';
import { CicloGiorno } from './fx/daynight.js?v=mtbzxc5q';
import { aggiornaLuci, aggiornaTempo, impostaPioggia, impostaRiflesso, impostaOmbre, impostaForo, impostaForzaRiflesso, impostaSchiumaAcqua, impostaSchiumaTop, creaLuce, creaLuceLeggera, spostaLuce, rimuoviLuce, impostaOcclusione, uniformiCondivise, impostaLatoMassimoVoxel, memoriaVoxel, statLuci, impostaParti, PARTI, impostaMaxOmbre, maxOmbre, impostaPassiCielo, passiCielo, impostaTerminatore, impostaProfiloShader, ambienteAttuale, impostaVentoFurni, urtaFurni, impostaAmbiente, filtroCieloLineare, cieloSorgente, impostaCampoSole, impostaControluce, impostaCorpi, materialeOmbra, materialiDiScorta, taraScartoOmbra, scostamentoNormale, passiMarcia, MARCIA_PASSI_MAX, raggiSole, conoSole, RAGGI_SOLE_MAX } from './fx/materials.js?v=mtbzxc5q';
import { CampoSole } from './fx/campoSole.js?v=mtbzxc5q';
import { Controluce, configuraMappa } from './fx/controluce.js?v=mtbzxc5q';
import { SchiumaTop, LAYER_SCHIUMA } from './fx/schiumaTop.js?v=mtbzxc5q';
import { ModalitaAR } from './ar/ar.js?v=mtbzxc5q';
import { Nuvole } from './fx/nuvole.js?v=mtbzxc5q';
import { SagomaVista } from './fx/sagomaVista.js?v=mtbzxc5q';
import { Erba } from './fx/erba.js?v=mtbzxc5q';
import { Foglie } from './fx/foglie.js?v=mtbzxc5q';
import { SegnaPercorso } from './fx/percorso.js?v=mtbzxc5q';
import { ComandiTouch } from './ui/comandi-touch.js?v=mtbzxc5q';
import { RiflessoAcqua } from './fx/riflesso.js?v=mtbzxc5q';
import { Pioggia } from './fx/pioggia.js?v=mtbzxc5q';
import { Particelle } from './fx/particelle.js?v=mtbzxc5q';
import { Audio } from './fx/audio.js?v=mtbzxc5q';
import { Creature, registraComponentiCreature, sistemaCreature, pensaCreatura } from './gioco/creature.js?v=mtbzxc5q';
import { RICETTE, puoiCraftare, crafta } from './gioco/craft.js?v=mtbzxc5q';
import { registraComponentiPalle, creaEntitaPalla, distruggiPalla, calciaPalla, sistemaPalle, sistemaResaPalle } from './gioco/palla.js?v=mtbzxc5q';
import { registraComponentiMacchine, GestoreMacchine, guidaMacchina, toccaMacchina, macchinaDi, haPannello, impostaConfig } from './gioco/macchine.js?v=mtbzxc5q';
import { PannelloMacchina } from './ui/pannelloMacchina.js?v=mtbzxc5q';
import { Registro } from './ecs/registro.js?v=mtbzxc5q';
import { Orologio, Rng } from './ecs/orologio.js?v=mtbzxc5q';
import { Sistemi } from './ecs/sistemi.js?v=mtbzxc5q';
import { Agenda } from './ecs/agenda.js?v=mtbzxc5q';
import { Gatto } from './player/player.js?v=mtbzxc5q';
import { ManoStrumento } from './player/mano.js?v=mtbzxc5q';
import { dropDi } from './gioco/drop.js?v=mtbzxc5q';
import { Controller } from './player/controller.js?v=mtbzxc5q';
import { FURNI, centroide } from './furniture/registry.js?v=mtbzxc5q';
import { caricaModelli } from './furniture/loader.js?v=mtbzxc5q';
import { Arredo } from './furniture/furniture.js?v=mtbzxc5q';
import { HUD } from './ui/hud.js?v=mtbzxc5q';
import { MenuDebug } from './ui/debug.js?v=mtbzxc5q';
import { Officina, caricaOfficina, registraDaRete, rimuoviDaRete } from './ui/officina.js?v=mtbzxc5q';
import { ModalitaXR } from './ar/ar-xr.js?v=mtbzxc5q';
import { serializza, applica, salvaLocale, caricaLocale, cancellaLocale, esportaFile, elencoSlot, salvaSlot, caricaSlot, rinominaSlot, cancellaSlot,
  ...
  migraOpzioni, leggiOpzioni, scriviOpzioni, VERSIONE_OPZIONI } from './save.js?v=mtbzxc5q';
