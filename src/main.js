...
import { PX, RAGGIO_CLICK, ACQUA, NET, SCAVO } from './config.js?v=ms85rw9m';
import { Rig } from './engine/renderer.js?v=ms85rw9m';
import { Input } from './engine/input.js?v=ms85rw9m';
import { raggioGriglia, raggioDaSchermo } from './engine/raycast.js?v=ms85rw9m';
import { Cadenza } from './engine/cadenza.js?v=ms85rw9m';
import { GpuProfiler, Campioni } from './engine/gpuTimer.js?v=ms85rw9m';
import { componiDiagnostica } from './engine/diagnostica.js?v=ms85rw9m';
import { SCENE } from './engine/banco.js?v=ms85rw9m';
import { BLOCCHI, CATEGORIE_BLOCCHI, defDi, tipoBase, livelloAcqua } from './world/blocks.js?v=ms85rw9m';
import { Mondo } from './world/world.js?v=ms85rw9m';
import { SimAcqua } from './world/acqua.js?v=ms85rw9m';
import { Lobby } from './net/lobby.js?v=ms85rw9m';
import { Segnalatore } from './net/segnalatore.js?v=ms85rw9m';
import { Bolla } from './ui/bolla.js?v=ms85rw9m';
import { Scelta } from './ui/scelta.js?v=ms85rw9m';
import { Bersaglio, POSE } from './gioco/bersaglio.js?v=ms85rw9m';
import { Zaino } from './ui/zaino.js?v=ms85rw9m';
import { Mesher, geometriaSingola } from './world/mesher.js?v=ms85rw9m';
import { generaIsola, generaArcipelago, generaOpenWorld, generaMondoGigante, SPAWN, ARREDO_INIZIALE } from './world/worldgen.js?v=ms85rw9m';
import { generaMostra } from './world/mostra.js?v=ms85rw9m';
import { generaCollaudo } from './world/collaudo.js?v=ms85rw9m';
import { generaTestLuci } from './world/testLuci.js?v=ms85rw9m';
import { generaBancoOmbre } from './world/bancoOmbre.js?v=ms85rw9m';
import { generaTestMacchine } from './world/testMacchine.js?v=ms85rw9m';
import { FuochiFatui } from './fx/fuochiFatui.js?v=ms85rw9m';
import { STAGIONI, impostaStagione, stagioneCorrente, ritingiFogliame, avviaTransizione, aggiornaTransizione } from './world/stagioni.js?v=ms85rw9m';
import { Meteo } from './fx/meteo.js?v=ms85rw9m';
import { Inventario, ATTREZZI } from './gioco/inventario.js?v=ms85rw9m';
import { Tavolozza, ZAMPA } from './gioco/tavolozza.js?v=ms85rw9m';
import { StriscaTavolozza } from './ui/tavolozza.js?v=ms85rw9m';
import { Scavo, DUREZZE } from './gioco/scavo.js?v=ms85rw9m';
import { CicloGiorno } from './fx/daynight.js?v=ms85rw9m';
import { aggiornaLuci, aggiornaTempo, impostaPioggia, impostaRiflesso, impostaOmbre, impostaForo, impostaForzaRiflesso, impostaSchiumaAcqua, impostaSchiumaTop, creaLuce, creaLuceLeggera, spostaLuce, rimuoviLuce, impostaOcclusione, uniformiCondivise, impostaLatoMassimoVoxel, memoriaVoxel, statLuci, impostaParti, PARTI, impostaMaxOmbre, maxOmbre, impostaPassiCielo, passiCielo, impostaTerminatore, ambienteAttuale } from './fx/materials.js?v=ms85rw9m';
import { SchiumaTop, LAYER_SCHIUMA } from './fx/schiumaTop.js?v=ms85rw9m';
import { ModalitaAR } from './ar/ar.js?v=ms85rw9m';
import { Nuvole } from './fx/nuvole.js?v=ms85rw9m';
import { SagomaVista } from './fx/sagomaVista.js?v=ms85rw9m';
import { Erba } from './fx/erba.js?v=ms85rw9m';
import { Foglie } from './fx/foglie.js?v=ms85rw9m';
import { SegnaPercorso } from './fx/percorso.js?v=ms85rw9m';
import { ComandiTouch } from './ui/comandi-touch.js?v=ms85rw9m';
import { RiflessoAcqua } from './fx/riflesso.js?v=ms85rw9m';
import { Pioggia } from './fx/pioggia.js?v=ms85rw9m';
import { Particelle } from './fx/particelle.js?v=ms85rw9m';
import { Audio } from './fx/audio.js?v=ms85rw9m';
import { Creature, registraComponentiCreature, sistemaCreature, pensaCreatura } from './gioco/creature.js?v=ms85rw9m';
import { RICETTE, puoiCraftare, crafta } from './gioco/craft.js?v=ms85rw9m';
import { registraComponentiPalle, creaEntitaPalla, distruggiPalla, calciaPalla, sistemaPalle, sistemaResaPalle } from './gioco/palla.js?v=ms85rw9m';
import { registraComponentiMacchine, GestoreMacchine, guidaMacchina, toccaMacchina, macchinaDi, haPannello } from './gioco/macchine.js?v=ms85rw9m';
import { PannelloMacchina } from './ui/pannelloMacchina.js?v=ms85rw9m';
import { Registro } from './ecs/registro.js?v=ms85rw9m';
import { Orologio, Rng } from './ecs/orologio.js?v=ms85rw9m';
import { Sistemi } from './ecs/sistemi.js?v=ms85rw9m';
import { Agenda } from './ecs/agenda.js?v=ms85rw9m';
import { Gatto } from './player/player.js?v=ms85rw9m';
import { ManoStrumento } from './player/mano.js?v=ms85rw9m';
import { dropDi } from './gioco/drop.js?v=ms85rw9m';
import { Controller } from './player/controller.js?v=ms85rw9m';
import { FURNI, centroide } from './furniture/registry.js?v=ms85rw9m';
import { caricaModelli } from './furniture/loader.js?v=ms85rw9m';
import { Arredo } from './furniture/furniture.js?v=ms85rw9m';
import { HUD } from './ui/hud.js?v=ms85rw9m';
import { MenuDebug } from './ui/debug.js?v=ms85rw9m';
import { Officina, caricaOfficina, registraDaRete, rimuoviDaRete } from './ui/officina.js?v=ms85rw9m';
import { ModalitaXR } from './ar/ar-xr.js?v=ms85rw9m';
import { serializza, applica, salvaLocale, caricaLocale, cancellaLocale, esportaFile, elencoSlot, salvaSlot, caricaSlot, rinominaSlot, cancellaSlot } from './save.js?v=ms85rw9m';
