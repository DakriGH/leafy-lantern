...
import { PX, RAGGIO_CLICK, ACQUA, NET, SCAVO, ANALITICA_URL, CHIAVE_SALVATAGGIO, CAMERA } from './config.js?v=mtbytwog';
import { Rig } from './engine/renderer.js?v=mtbytwog';
import { Input } from './engine/input.js?v=mtbytwog';
import { raggioGriglia, raggioDaSchermo } from './engine/raycast.js?v=mtbytwog';
import { Cadenza } from './engine/cadenza.js?v=mtbytwog';
import { GpuProfiler } from './engine/gpuTimer.js?v=mtbytwog';
import { creaBatteria } from './engine/batteria.js?v=mtbytwog';
import { BLOCCHI, CATEGORIE_BLOCCHI, defDi, tipoBase, livelloAcqua } from './world/blocks.js?v=mtbytwog';
import { Mondo } from './world/world.js?v=mtbytwog';
import { SimAcqua } from './world/acqua.js?v=mtbytwog';
import { Lobby } from './net/lobby.js?v=mtbytwog';
import { Segnalatore } from './net/segnalatore.js?v=mtbytwog';
import { avviaAnalitica, urlPannello } from './net/analitica.js?v=mtbytwog';
import { puo as ruoloPuo, DESCRIZIONE as RUOLO_DESCR, RUOLI } from './net/permessi.js?v=mtbytwog';
import { leggiProfilo, salvaProfilo, COLORI as COLORI_PROFILO } from './net/profilo.js?v=mtbytwog';
import { PannelloInsieme } from './ui/multiplayer.js?v=mtbytwog';
import { Targhetta } from './ui/targhetta.js?v=mtbytwog';
import { Bolla } from './ui/bolla.js?v=mtbytwog';
import { Scelta } from './ui/scelta.js?v=mtbytwog';
import { Bersaglio, POSE } from './gioco/bersaglio.js?v=mtbytwog';
import { Zaino } from './ui/zaino.js?v=mtbytwog';
import { Mesher, geometriaSingola } from './world/mesher.js?v=mtbytwog';
import { generaIsola, generaArcipelago, generaOpenWorld, generaMondoGigante, SPAWN, ARREDO_INIZIALE } from './world/worldgen.js?v=mtbytwog';
import { generaMostra } from './world/mostra.js?v=mtbytwog';
import { generaCollaudo } from './world/collaudo.js?v=mtbytwog';
import { generaTestLuci } from './world/testLuci.js?v=mtbytwog';
import { generaBancoOmbre } from './world/bancoOmbre.js?v=mtbytwog';
import { generaTestMacchine } from './world/testMacchine.js?v=mtbytwog';
import { generaZoo } from './world/zoo.js?v=mtbytwog';
import { FuochiFatui } from './fx/fuochiFatui.js?v=mtbytwog';
import { STAGIONI, impostaStagione, stagioneCorrente, ritingiFogliame, avviaTransizione, aggiornaTransizione } from './world/stagioni.js?v=mtbytwog';
import { Meteo } from './fx/meteo.js?v=mtbytwog';
import { Inventario, ATTREZZI } from './gioco/inventario.js?v=mtbytwog';
import { Tavolozza, ZAMPA } from './gioco/tavolozza.js?v=mtbytwog';
import { StriscaTavolozza } from './ui/tavolozza.js?v=mtbytwog';
import { Scavo, DUREZZE } from './gioco/scavo.js?v=mtbytwog';
import { CicloGiorno } from './fx/daynight.js?v=mtbytwog';
import { aggiornaLuci, aggiornaTempo, impostaPioggia, impostaRiflesso, impostaOmbre, impostaForo, impostaForzaRiflesso, impostaSchiumaAcqua, impostaSchiumaTop, creaLuce, creaLuceLeggera, spostaLuce, rimuoviLuce, impostaOcclusione, uniformiCondivise, impostaLatoMassimoVoxel, memoriaVoxel, statLuci, impostaParti, PARTI, impostaMaxOmbre, maxOmbre, impostaPassiCielo, passiCielo, impostaTerminatore, impostaProfiloShader, ambienteAttuale, impostaVentoFurni, urtaFurni, impostaAmbiente, filtroCieloLineare, cieloSorgente, impostaCampoSole, impostaControluce, impostaCorpi, materialeOmbra, materialiDiScorta, taraScartoOmbra, scostamentoNormale, passiMarcia, MARCIA_PASSI_MAX, raggiSole, conoSole, RAGGI_SOLE_MAX } from './fx/materials.js?v=mtbytwog';
import { CampoSole } from './fx/campoSole.js?v=mtbytwog';
import { Controluce, configuraMappa } from './fx/controluce.js?v=mtbytwog';
import { SchiumaTop, LAYER_SCHIUMA } from './fx/schiumaTop.js?v=mtbytwog';
import { ModalitaAR } from './ar/ar.js?v=mtbytwog';
import { Nuvole } from './fx/nuvole.js?v=mtbytwog';
import { SagomaVista } from './fx/sagomaVista.js?v=mtbytwog';
import { Erba } from './fx/erba.js?v=mtbytwog';
import { Foglie } from './fx/foglie.js?v=mtbytwog';
import { SegnaPercorso } from './fx/percorso.js?v=mtbytwog';
import { ComandiTouch } from './ui/comandi-touch.js?v=mtbytwog';
import { RiflessoAcqua } from './fx/riflesso.js?v=mtbytwog';
import { Pioggia } from './fx/pioggia.js?v=mtbytwog';
import { Particelle } from './fx/particelle.js?v=mtbytwog';
import { Audio } from './fx/audio.js?v=mtbytwog';
import { Creature, registraComponentiCreature, sistemaCreature, pensaCreatura } from './gioco/creature.js?v=mtbytwog';
import { RICETTE, puoiCraftare, crafta } from './gioco/craft.js?v=mtbytwog';
import { registraComponentiPalle, creaEntitaPalla, distruggiPalla, calciaPalla, sistemaPalle, sistemaResaPalle } from './gioco/palla.js?v=mtbytwog';
import { registraComponentiMacchine, GestoreMacchine, guidaMacchina, toccaMacchina, macchinaDi, haPannello, impostaConfig } from './gioco/macchine.js?v=mtbytwog';
import { PannelloMacchina } from './ui/pannelloMacchina.js?v=mtbytwog';
import { Registro } from './ecs/registro.js?v=mtbytwog';
import { Orologio, Rng } from './ecs/orologio.js?v=mtbytwog';
import { Sistemi } from './ecs/sistemi.js?v=mtbytwog';
import { Agenda } from './ecs/agenda.js?v=mtbytwog';
import { Gatto } from './player/player.js?v=mtbytwog';
import { ManoStrumento } from './player/mano.js?v=mtbytwog';
import { dropDi } from './gioco/drop.js?v=mtbytwog';
import { Controller } from './player/controller.js?v=mtbytwog';
import { FURNI, centroide } from './furniture/registry.js?v=mtbytwog';
import { caricaModelli } from './furniture/loader.js?v=mtbytwog';
import { Arredo } from './furniture/furniture.js?v=mtbytwog';
import { HUD } from './ui/hud.js?v=mtbytwog';
import { MenuDebug } from './ui/debug.js?v=mtbytwog';
import { Officina, caricaOfficina, registraDaRete, rimuoviDaRete } from './ui/officina.js?v=mtbytwog';
import { ModalitaXR } from './ar/ar-xr.js?v=mtbytwog';
import { serializza, applica, salvaLocale, caricaLocale, cancellaLocale, esportaFile, elencoSlot, salvaSlot, caricaSlot, rinominaSlot, cancellaSlot,
  ...
  migraOpzioni, leggiOpzioni, scriviOpzioni, VERSIONE_OPZIONI } from './save.js?v=mtbytwog';
...
/**
 * IL TETTO DELLE LAMELLE, ed è il numero che decide se il prato è un TAPPETO o
 * una spolverata.
 *
 * ⚠ ERA 30.000 E MORDEVA SEMPRE: nel mondo gigante il conto stava a 29.998, cioè
 * il prato non era «quanto ne serve», era «quanto ce ne sta». Alzare la densità
 * non cambiava niente — il tetto tagliava comunque, e a tagliare erano le
 * lamelle più lontane, cioè quelle in dissolvenza. Committente: «modifichiamo
 * l'erba in modo che sia trenta volte la quantità attuale, deve essere super
 * ottimizzata, un tappetino morbido dove presente».
 *
 * ⚠ E IL TETTO NON BASTA DA SOLO: senza il diradamento per distanza
 * (`passoPerDistanza`) le lamelle finirebbero per metà oltre l'orizzonte utile.
 * Il tappeto si fa fitto DOVE SI GUARDA e rado in fondo.
 *
 * ⚠ IL TETTO NON È «IL PIÙ ALTO CHE REGGE», È QUELLO CHE SERVE — ed è la
 * correzione di un mio eccesso. Ero salito a 900.000 per essere sicuro che non
 * mordesse mai; poi ho misurato il caso peggiore vero (anello a passo pieno
 * 5×5 chunk tutti a erba, densità 8: ~243k, più i due anelli diradati, ~190k)
 * e sta sotto i 450.000. Il resto era buffer allocato per niente — e non è
 * memoria e basta: `_scambia` senza intervalli di aggiornamento spedisce alla
 * GPU l'INTERO array, non le lamelle scritte. Cinquecentomila con gli
 * intervalli costano meno di trecentomila senza. Il conto misurato sul mondo
 * gigante con la densità al massimo è 203.447 lamelle: il tetto non morde.
 */
const ERBA_MAX = rig.mobile ? 120000 : 500000;
/** La densità a qualità piena (manuale). La scala di qualità scende da qui. */
const ERBA_DENSITA_MAX = 8;
const erba = new Erba(rig.scena, { max: ERBA_MAX });
...
/** Lo scarto della mappa d'ombra, IN BLOCCHI.
 *
 * ⚠ TARATO GUARDANDO, non dedotto, e la finestra è stretta. Misurato e visto
 * sullo zoo, stazione 3, mezzogiorno congelato:
 *   0,05 → il lastricato si riempie di acne lungo il bordo
 *   0,15 → pulito, e le ombre restano attaccate alla base      ← questo
 *   0,60 → i pilastri cominciano a perdere la propria ombra
 *   1,40 → peter-panning conclamato: orlo chiaro alla base di tutto
...
// I TRE SISTEMI D'OMBRA DEL SOLE, che convivono per poterli confrontare a
// schermo invece che a memoria. Il bottone del Banco V2 li cicla.
//   'campo'      — fx/campoSole.js, la quota per colonna (com'era)
//   'controluce' — fx/controluce.js, la mappa di profondità (§14)
//   'marcia'     — la griglia dei voxel camminata come fanno le lampade
const SISTEMI_OMBRA = ['controluce', 'marcia', 'campo'];
// ⚠ LA MARCIA È DI FABBRICA, e la scelta viene da due misure e da due
// bocciature. Il committente il 27/08, guardando Controluce: «tremenda, ombre
// seghettate e un sacco di acne». Controluce campiona un reticolo SUO e sulle
// pareti quasi parallele al raggio nessuno scarto costante basta — l'indice di
// frastagliatura misurato saliva a 0,20-0,80 secondo l'ora, ed è acne. La
// marcia non ha un reticolo: cammina la griglia dei voxel come le lampade, e il
// bordo cade sullo SPIGOLO DEL BLOCCO. Niente scarto, niente acne per
// costruzione — che è anche il motivo per cui «il cono di luce è perfetto».
// E costa meno delle altre due: 43,82 contro 43,83 e 43,84 su un giro assestato.
// Controluce resta nel ciclo del bottone 🌓, che serve a confrontare.
// ⚠ ADESSO IL PREDEFINITO È «CONTROLUCE», e stamattina era la marcia. Il
// ribaltamento è tutto in due misure, quindi lo scrivo invece di cambiare la
// riga e basta.
//
// La marcia era nata perché la mappa aveva due difetti veri: l'ACNE sulle
// pareti del terreno (che competevano con sé stesse) e la SCALINATA del
// reticolo sul bordo. Erano ragioni giuste, e per curarle avevo tolto il
// terreno dalla mappa e lo avevo mandato a camminare la griglia dei voxel.
//
// Poi però le due cause sono state curate DOVE STAVANO: lo scarto adesso cresce
// con la pendenza (§14.20, che è la cura dell'acne sulle superfici inclinate) e
// la lettura è a quattro prese affilate a un pixel (che è la cura della
// scalinata). Rimessa alla prova con quelle due cose addosso, la mappa vince su
// tutt'e due gli assi:
//   · GUARDANDO: nessuna acne a 10°, 20°, 45° e 70° di elevazione, e le
//     terrazze hanno finalmente le loro ombre portate — con la marcia il
//     terreno restava quasi tutto illuminato;
//   · MISURANDO (freno GPU a 210 MHz, mondo gigante, 1080p): controluce 5,07 e
//     5,22 ms contro 7,13 e 7,04 della marcia. **Il 28% in meno**, ripetuto due
//     volte a coppie alternate.
// Il perché del costo è semplice: la marcia è fino a VENTOTTO letture di texture
// 3D per pixel, la mappa è quattro letture di una texture 2D. La marcia resta
// nel ciclo del bottone 🌓 perché serve a confrontare, non perché serva a giocare.
let _sistemaOmbra = 'controluce';
let _controluceOn = true;
/** ⚠ QUI E NON PIÙ IN BASSO: il menu di debug legge lo stato nel COSTRUTTORE, e
 *  una `let` letta prima della sua riga è pagina nera. È già successo due volte
 *  (vedi test/menu-debug-tdz.test.mjs), e la seconda l'ho pubblicata. */
let _corpiOn = false;
...
// MenuDebug costruisce le manopole e le LEGGE subito, e un `let` non si issa.
// Dichiararlo dopo dava «Cannot access '_scartoBlocchi' before initialization»
// a pagina nera, con l'errore che punta a main.js e non nomina il menu.
...
const menuDebug = new MenuDebug({
  ...
  azioni: {
    ...
    controluce: () => sistemaOmbra(),
    controluceStato: () => _sistemaOmbra,
    corpi: (on) => corpiOmbra(on),
    corpiStato: () => _corpiOn,
    soleBisturiStato: () => (uniformiCondivise().uParti.value & PARTI.sole) !== 0,
    scartoOmbra: (b) => scartoOmbra(b),
    scostaNormale: (n) => scostamentoNormale(n),
    campioni: (n) => (n === undefined ? rig.campioni : rig.setCampioni(n)),
    // ⚠ LETTURA E SCRITTURA SONO DUE AZIONI, e non è pignoleria: il menu chiama
    // le LETTURE nel costruttore, cioè prima che `qManuale` e `opzioni`
    // esistano. Tenerle in una funzione sola con un ritorno anticipato
    // funzionerebbe a runtime — il ramo di lettura esce prima di toccarle — ma
    // lascia una chiusura che NOMINA un `let` non ancora inizializzato: una
    // mina che scoppia il giorno che qualcuno sposta quel return.
    // `test/menu-debug-tdz.test.mjs` non me l'ha lasciato passare, ed è la terza
    // volta oggi che questa classe di difetto ci prova: le prime due sono
    // arrivate a pagina nera, questa no.
    scalaResa: () => rig.scalaInterna,
    impostaScala: (s) => { qManuale = true; opzioni.scala = s; applicaQualita(); },
    passiMarcia: (n) => passiMarcia(n),
    affilaOmbra: (v) => {
      const u = uniformiCondivise().uAffilaOmbra;
      if (v !== undefined) u.value = Math.max(0, v);
      return u.value;
    },
    morbidezzaOmbra: (v) => {
      const u = uniformiCondivise();
      if (v !== undefined) { u.uControluceRaggio.value = v; u.uCorpiRaggio.value = v; }
      return u.uControluceRaggio.value;
    },
    raggiSole: (n) => raggiSole(n),
    conoSole: (a) => conoSole(a),
    passiMarciaMax: () => MARCIA_PASSI_MAX,
    // le manopole del sole non sanno niente della chiave della mappa: dopo una
    // manopola la mappa va rifatta a mano, se no si guarda l'ombra di prima.
    rifaiOmbra: () => { controluce.chiave = ''; },
    // IL BISTURI DEL SOLE: una uniform, non una ricompilazione. Rende `true` se
    // l'ombra è ACCESA, così il pannello può marcare il bottone al contrario.
    soleBisturi: () => {
      const m = uniformiCondivise().uParti.value ^ PARTI.sole;
      impostaParti(m);
      return (m & PARTI.sole) !== 0;
    },
...
const LIVELLI_Q = rig.mobile ? [
  ...
  { rifl: false, ombre: false, schiuma: true, acquaRicca: true, maxOmbre: 6, sole: 10, scala: 1, dist: 700, erba: 6, erbaR: 5, raggi: 1, marcia: 12, bordiMorbidi: false, campioni: 0 },
  { rifl: false, ombre: false, schiuma: false, acquaRicca: false, maxOmbre: 4, sole: 6, scala: 0.9, dist: 500, erba: 4.2, erbaR: 4, raggi: 1, marcia: 8, bordiMorbidi: false, campioni: 0 },
  { rifl: false, ombre: false, schiuma: false, acquaRicca: false, maxOmbre: 3, sole: 6, scala: 0.82, dist: 500, erba: 3, erbaR: 3, raggi: 1, marcia: 6, bordiMorbidi: false, campioni: 0 },
  { rifl: false, ombre: false, schiuma: false, acquaRicca: false, maxOmbre: 2, sole: 6, scala: 0.66, dist: 360, erba: 2.1, erbaR: 2, raggi: 1, marcia: 4, bordiMorbidi: false, campioni: 0 },
  { rifl: false, ombre: false, schiuma: false, acquaRicca: false, maxOmbre: 1, sole: 0, scala: 0.55, dist: 280, erba: 1.2, erbaR: 2, raggi: 1, marcia: 0, bordiMorbidi: false, campioni: 0 },
  { rifl: false, ombre: false, schiuma: false, acquaRicca: false, maxOmbre: 0, sole: 0, scala: 0.45, dist: 220, erba: 0.9, erbaR: 1, raggi: 1, marcia: 0, bordiMorbidi: false, campioni: 0 },
] : [
  ...
  { rifl: true, ombre: true, schiuma: true, acquaRicca: true, maxOmbre: 8, sole: 13, scala: 1, dist: 900, erba: 7.8, erbaR: 6, raggi: 1, marcia: 28, bordiMorbidi: true, campioni: 4 },
  { rifl: false, ombre: false, schiuma: true, acquaRicca: true, maxOmbre: 6, sole: 12, scala: 0.9, dist: 700, erba: 6, erbaR: 5, raggi: 1, marcia: 20, bordiMorbidi: true, campioni: 4 },
  ...
  { rifl: false, ombre: false, schiuma: false, acquaRicca: false, maxOmbre: 4, sole: 8, scala: 0.8, dist: 500, erba: 3.6, erbaR: 3, raggi: 1, marcia: 14, bordiMorbidi: false, campioni: 2 },
  { rifl: false, ombre: false, schiuma: false, acquaRicca: false, maxOmbre: 2, sole: 6, scala: 0.72, dist: 500, erba: 2.7, erbaR: 3, raggi: 1, marcia: 10, bordiMorbidi: false, campioni: 2 },
  { rifl: false, ombre: false, schiuma: false, acquaRicca: false, maxOmbre: 1, sole: 0, scala: 0.62, dist: 360, erba: 1.8, erbaR: 2, raggi: 1, marcia: 6, bordiMorbidi: false, campioni: 0 },
  ...
  { rifl: false, ombre: false, schiuma: false, acquaRicca: false, maxOmbre: 0, sole: 0, scala: 0.53, dist: 300, erba: 1.2, erbaR: 2, raggi: 1, marcia: 0, bordiMorbidi: false, campioni: 0 },
  { rifl: false, ombre: false, schiuma: false, acquaRicca: false, maxOmbre: 0, sole: 0, scala: 0.45, dist: 240, erba: 0.9, erbaR: 1, raggi: 1, marcia: 0, bordiMorbidi: false, campioni: 0 },
];
// ⚠️ IL FOTOGRAMMA È PROPORZIONALE AI PIXEL, E BASTA — misurato il 27/08 con il
// freno a 210 MHz, open world, macchina assestata (spread 0,03-0,08 ms):
//     1,78 Mpx → 13,21 ms (7,44 ms/Mpx) · 3,56 → 27,89 (7,83)
//     7,11 Mpx → 52,35 ms (7,37 ms/Mpx) · 14,26 → 84,95 (5,96)
// Il costo PER PIXEL è costante e il costo fisso è ~zero: otto volte i pixel,
// sei volte e mezzo il tempo. Conseguenza scomoda ma netta: NON esiste una
// funzionalità grassa da tagliare. Misurate una per una sullo stesso banco,
// valgono tutte pochi punti percentuali — l'acqua INTERA è lo 0,95 ms su 29,75
// (3,2%), di cui 0,81 sono gli anelli delle cascate. Il resto è il costo di
// ombreggiare ogni pixel, e l'unica leva vera è QUANTI pixel.
//
// ⚠️ E LA SCALA PARTIVA TROPPO TARDI. I primi TRE gradini desktop erano tutti a
// `scala: 1`: il paracadute spendeva i suoi primi due scalini su voci che valgono
// pochi punti l'una, e la leva che vale il 100% non si muoveva fino al terzo.
// Adesso scende da subito (1 → 0,9 → 0,8 → 0,82 …), che è anche la cosa che il
// committente aveva intuito da solo: «pixel più grandi per prestazioni più basse».
//
// ⚠️ OGNI LIVELLO DICHIARA `erba` E `erbaR`, E NON È PIGNOLERIA: era la
// MANOPOLA INVERTITA. Le due chiavi stavano solo sui primi tre gradini desktop e
// su NESSUN gradino mobile; applicaQualita le legge con `q.erba ?? 1` e
// `q.erbaR ?? 5` (più sotto), quindi dove mancavano tornava il DEFAULT — che è
// il valore ALTO. Effetto misurato leggendo la tabella: scendendo dal livello 2
// al 3 — cioè peggiorando la qualità PERCHÉ la macchina arranca — la densità
// dell'erba SALIVA da 0,6 a 1,0 e il raggio da 3 a 5 chunk, cioè ~4,6× di
// lamelle (0,6→1,0 di densità per 2,8× di area). Su MOBILE la manopola non
// esisteva proprio: sempre 1,0 e 5, su tutta la scala.
// Non è un dettaglio d'erba: misurato col freno GPU a 17,8 Mpx sullo zoo, erba
// e foglie valgono 1,91 ms su 9,60, cioè il 20% del fotogramma. Il paracadute
// tirava nella direzione sbagliata proprio sul dispositivo per cui esiste.
// `test/qualita-scala.test.mjs` pretende adesso che TUTTA la scala sia
// monotona, così il prossimo gradino aggiunto non può ripetere l'omissione.
let qLivello = 0;
...
const PRESET_GRAFICA = {
  // ⚠ IL GRADINO PER LE MACCHINE DAVVERO DEBOLI, chiesto dal committente:
  // «creare i profili per i dispositivi più scarsi». «Bassa» partiva da 0,66 di
  // scala e teneva l'erba: sul Chromebook non basta, e la scala automatica ci
  // arriva solo DOPO aver fatto vedere i cali — cioè dopo aver fatto una brutta
  // figura. Qui si parte già in fondo e si lascia che la scala risalga se può.
  //
  // I due numeri che contano su una GPU integrata, misurati oggi col freno a
  // 210 MHz: i PIXEL (il fotogramma scala con loro finché non si è più
  // fill-bound) e l'ERBA (trentamila lamelle sono trentamila draw di vertici).
  // Quindi qui la scala scende a 0,5 e l'erba si spegne: sono le due manopole
  // con più millisecondi dentro, e spegnere l'erba è meno brutto che rendere
  // tutto sfocato — un prato di moquette si legge, un mondo sgranato no.
  minima: {
    scala: 0.5, riflessi: false, luceCotta: false, riflForza: 0.4, dist: 180, fog: 1,
    nitido: false, ombraSole: false, solePassi: 0, soleTerm: false, soleForza: 1, soleRaggi: 1,
    erba: false, soleMarcia: 0, campioni: 0, bordiMorbidi: false, autoQ: true,
  },
  bassa: {
    scala: 0.66, riflessi: false, luceCotta: false, riflForza: 0.6, dist: 250, fog: 0.9,
    nitido: true, ombraSole: false, solePassi: 0, soleTerm: false, soleForza: 1, soleRaggi: 1,
    erba: true, soleMarcia: 0, campioni: 0, bordiMorbidi: false, autoQ: true,
  },
  media: {
    scala: 0.85, riflessi: false, luceCotta: true, riflForza: 0.8, dist: 450, fog: 0.7,
    nitido: true, ombraSole: true, solePassi: 8, soleTerm: false, soleForza: 1, soleRaggi: 1,
    erba: true, soleMarcia: 14, campioni: 2, bordiMorbidi: false, autoQ: true,
  },
  alta: {
    scala: 1, riflessi: true, luceCotta: true, riflForza: 1, dist: 700, fog: 0.55,
    nitido: true, ombraSole: true, solePassi: 12, soleTerm: false, soleForza: 1, soleRaggi: 1,
    erba: true, soleMarcia: 22, campioni: 4, bordiMorbidi: true, autoQ: true,
  },
  ultra: {
    scala: 1, riflessi: true, luceCotta: true, riflForza: 1.2, dist: 900, fog: 0.4,
    nitido: true, ombraSole: true, solePassi: 13, soleTerm: false, soleForza: 1, soleRaggi: 1,
    erba: true, soleMarcia: 28, campioni: 4, bordiMorbidi: true, autoQ: false,
  },
};
...
function applicaQualita() {
  ...
  // I BORDI MORBIDI DELLA MAPPA: sui gradini alti sì, scendendo no.
  // ⚠ IL PROFILO E LA SCALA AUTOMATICA DEVONO POTER DIRE LA LORO TUTT'E DUE, e
  // vince il più prudente — come già fanno `scala` e `dist` con un `min`. Con un
  // `qManuale ? … : …` secco il profilo scelto a mano NON MORDEVA finché la
  // qualità automatica era accesa, che è il caso di quattro profili su cinque:
  // misurato, «Ultra» e «Minima» davano lo stesso budget di marcia (28) perché
  // comandava solo il gradino della scala, fermo in cima. Un profilo che non
  // cambia niente è il difetto che il committente ha già trovato una volta.
  _bordiMorbidi = (qManuale || q.bordiMorbidi === true) && opzioni.bordiMorbidi !== false;
  // ⚠ IL BUDGET DELLA MARCIA È LA MANOPOLA PIÙ GROSSA CHE C'È, e fino a stasera
  // non la toccava nessuno: usciva dal menu di debug e restava al massimo su
  // qualunque dispositivo. È il termine più caro del fragment — fino a
  // ventotto letture di texture 3D per pixel — e il conto è LINEARE nei passi.
  // Misurato col freno a 210 MHz sul mondo gigante: 28 passi 9,22 ms · 20 passi
  // 8,11 · 14 passi 6,98 · 8 passi 6,47 · 4 passi 5,58. Da 28 a 14 è un quarto
  // del fotogramma, e in cambio l'ombra più lunga arriva a quattordici blocchi
  // invece che a ventotto: su una macchina debole è il baratto giusto, e su
  // quella forte non lo si fa.
  passiMarcia(Math.min(qManuale ? MARCIA_PASSI_MAX : (q.marcia ?? MARCIA_PASSI_MAX),
    opzioni.soleMarcia ?? MARCIA_PASSI_MAX));
  ...
  // I RAGGI DEL CONO SONO UNA FASCIA, ed è la risposta a «possiamo arrivare a
  // compromessi con diverse fasce di grafica?». Misurato col freno a 210 MHz e
  // 18,8 Mpx: 1 raggio 74 ms · 2 raggi 97 (+31%) · 4 raggi 144 (+95%). Il costo
  // è lineare nei raggi perché ogni raggio è una marcia intera — quindi la
  // morbidezza è esattamente il genere di cosa che sta bene in cima alla scala
  // e non in fondo. Un raggio è il taglio netto, cioè l'aspetto di sempre.
  // ⚠ IL DEFAULT MANUALE NON È 1, ed è la stessa trappola di `erba` e di
  // `solePassi`: `?? 1` faceva cadere la morbidezza al MINIMO appena qualcuno
  // toccava una voce qualunque del menu Grafica — cioè proprio a chi va a
  // cercare le impostazioni. Un default che coincide col fondo scala non è un
  // default: è uno spegnimento travestito. Adesso `soleRaggi` sta in
  // OPZ_DEFAULT e nei quattro preset, quindi in manuale vale quello che il
  // profilo dice.
  raggiSole(qManuale ? (opzioni.soleRaggi ?? (rig.mobile ? 1 : 3)) : (q.raggi ?? 1));
  // I BORDI: la scaletta dei poligoni è un'altra cosa dai pixel grandi, e ha la
  // sua manopola. Vedi rig.setCampioni — sotto scala 1 l'antialias del contesto
  // NON arriva al bersaglio interno, quindi va riacceso lì.
  // ⚠⚠ IL DIFETTO PIÙ CARO DELLA GIORNATA STAVA IN QUESTO `?? 0`. `campioni` è
  // l'MSAA — i bordi della GEOMETRIA — e non stava né in OPZ_DEFAULT né nei
  // profili. Quindi in manuale (che è dove sta «Ultra») `opzioni.campioni` era
  // `undefined`, il `?? 0` lo leggeva come ZERO, e scegliere il profilo più alto
  // SPEGNEVA l'antialiasing. Il committente l'ha visto così: «tutto seghettato»
  // — non le ombre, tutto. È la stessa trappola già trovata due volte
  // (`erba` nella scala, `soleRaggi` nei preset): un default che rientra dalla
  // finestra, e che è sempre il valore che costa meno.
  // ⚠ E I DUE SI COMBINANO COL PIÙ PRUDENTE, come `scala`, `dist` e
  // `soleMarcia`: con un `qManuale ? … : …` secco il profilo scelto a mano non
  // morde finché la qualità automatica è accesa — e lo è in quattro profili su
  // cinque. Misurato: «Minima» chiedeva zero campioni e ne otteneva quattro.
  rig.setCampioni(Math.min(qManuale ? 4 : (q.campioni ?? 0),
    opzioni.campioni ?? (rig.mobile ? 0 : 4)));
  erba.densita = qManuale ? ERBA_DENSITA_MAX : (q.erba ?? 1);
  ...
  // ⚠ LE FOGLIE NON SEGUONO L'ERBA nel moltiplicatore: sono MUCCHI, e un mucchio
  // trenta volte più fitto è una macchia piatta. Restano al loro valore.
  foglie.densita = qManuale ? 1 : Math.min(1.3, q.erba ?? 1);
  ...
  // ⚠ E SE LA MAPPA DEI CORPI È ACCESA, I CONI SI SPENGONO. Sono due sistemi che
  // disegnano la STESSA ombra: tenerli insieme la disegna due volte, e un corpo
  // finirebbe più scuro di qualunque altra ombra del gioco — cioè il difetto si
  // vedrebbe come «il gatto è troppo nero», che non fa pensare a due sistemi.
  if (_corpiOn) _partiQ &= ~PARTI.personaggi;
...
// ═══ CONTROLUCE — la mappa d'ombra del sole (docs/LEAFY-V2.md §14). ═══
// NASCE SPENTA, e vive accanto al campo: è la regola 2 del cantiere, e qui vale
// doppio perché è la TERZA cura di questo difetto. Si accende dal Banco V2, si
// guarda dalla stazione 3 dello zoo, e il numero che la promuove è l'indice di
// frastagliatura (bancoPixel.frastagliatura): oggi 0,140, bersaglio ≤ 0,05.
/** L'altezza del BUFFER di resa, in pixel. ⚠ Si legge `height` e non
 *  `clientHeight`: `clientHeight` è una misura di LAYOUT e leggerla ogni
 *  fotogramma obbligherebbe il browser a ricalcolare lo stile prima di
 *  rispondere. `height` è quello che `setSize` ha scritto, cioè esattamente i
 *  pixel che si disegnano — e non costa niente. */
function _altezzaResa() { return rig.renderer.domElement.height || Math.round(innerHeight) || 1080; }
function _confDaSchermo(h) {
  return configuraMappa({
    hRender: h,
    fovGradi: CAMERA.fov, pxBersaglio: rig.mobile ? 4 : 2, tetto: rig.mobile ? 1024 : 2048,
  });
}
/** I bordi morbidi della mappa d'ombra (filtro a quattro prese). Lo decide la
 *  scala di qualità: costa +0,23 ms su 2,52 a 1080p, misurato — poco, ma non
 *  zero, e sulle macchine deboli i pixel valgono più dei bordi. */
/** ⚠ IL RAGGIO DEL FILTRO D'OMBRA, IN TEXEL, e i due valori sono scelti così:
 *  · MINIMO = 1 → quattro prese su un texel. Toglie la SCALINATA del reticolo,
 *    che è il difetto che non deve tornare mai — ma lascia vedere i «ginocchi»
 *    (la iso-linea è un arco per texel, e archi vicini non combaciano in
 *    tangente). È il gradino dei dispositivi deboli.
 *  · MORBIDO = 2 → griglia 3×3 di prese bilineari su due texel. I ginocchi si
 *    mediano fra loro e sotto la media non si vedono. È la penombra vera che il
 *    committente ha chiesto: «solo ombre smooth perfette».
 *  Sotto 1 c'è solo la scalinata, e non è un'opzione. */
// ⚠ E TUTT'E DUE SONO ≥ 2, cioè tutt'e due SMOOTH. Misurato col freno GPU a
// 210 MHz a 1080p sul mondo gigante: raggio 0 → 6,69 ms · 1 → 6,43 · 2 → 6,63 ·
// 3 → 6,43. Il filtro largo NON SI PAGA — trentasei letture per pixel stanno
// tutte nella cache di una texture piccola. Quindi non c'è nessuna ragione di
// dare la versione a gradini a nessun dispositivo: il gradino basso è «morbido»
// e quello alto è «più morbido».
const RAGGIO_OMBRA_MINIMO = 2;
const RAGGIO_OMBRA_MORBIDO = 3;
let _bordiMorbidi = true;
let _hControluce = _altezzaResa();
const _confControluce = _confDaSchermo(_hControluce);
const controluce = new Controluce(rig.renderer, _confControluce.N);

/**
 * RIMISURA LA MAPPA SULLO SCHERMO VERO.
 *
 * ⚠ NON È UNA RIFINITURA: è la differenza fra un texel da 0,047 unità e uno da
 * 0,1875. `configuraMappa` deriva il lato dall'ALTEZZA DI RESA, e quell'altezza
 * cambia — si ridimensiona la finestra, la scala di qualità scende, o
 * semplicemente la si è letta prima che il renderer dimensionasse la tela. Una
 * misura presa una volta sola, quando sbaglia, sbaglia per sempre: la mappa
 * resta al minimo (512) su qualunque schermo, e le ombre dei mobili diventano
 * quadrati grossi otto pixel. L'ho visto succedere nel mio banco, con la
 * fotografia a fianco della sua: è lo stesso difetto.
 *
 * Si chiama al ridimensionamento E una volta dopo l'avvio, perché il primo
 * fotogramma è proprio il momento in cui la tela può non essere ancora a misura.
 */
function adeguaControluce() {
  const h = _altezzaResa();
  if (h === _hControluce) return false;        // un confronto di interi per frame
  _hControluce = h;
  const c = _confDaSchermo(h);
  const cambiato = controluce.ridimensiona(c.N);
  Object.assign(_confControluce, c);
  return cambiato;
}

// ═══ LA MAPPA DEI CORPI IN MOVIMENTO (§14.23) ═══
//
// ⚠ ESCE SPENTA, ed è la regola 2 del cantiere: il sistema nuovo vive accanto al
// vecchio finché il numero sul dispositivo del committente non lo giustifica.
// Il vecchio sono i coni sotto i piedi (`ombraPg`, stile Bedrock): un disco che
// scurisce quello che attraversa, sempre verticale, sempre tondo. Per un gatto
// va bene; per un'automobile o un NPC no — non ha la forma del corpo, non
// segue il sole, e non si allunga al tramonto. E i veicoli sono la prossima
// cosa che il committente vuole costruire.
//
// PICCOLA E RIFATTA OGNI FOTOGRAMMA, che è l'esatto contrario della mappa del
// sole: quella è grande e cachata perché ci sta dentro roba ferma. Qui dentro ci
// sono quattro o cinque corpi, quindi il disegno è pochi triangoli — il costo
// vero è la PULIZIA del bersaglio, e per quello si tiene piccolo.
const _confCorpi = { N: rig.mobile ? 512 : 1024, raggio: 16 };
const corpi = new Controluce(rig.renderer, _confCorpi.N);
corpi.intervalloMin = 0;         // ogni fotogramma: è tutta la ragione per cui esiste
const _nascostiCorpi = [];

/** I corpi che si muovono: gatto, ospiti, palle, creature. ⚠ ELENCO, non
 *  «tutto meno qualcosa» — la stessa lezione della mappa del sole. */
function proiettanoCorpi() {
  _proiettanoC.clear();
  if (gatto.gruppo) _proiettanoC.add(gatto.gruppo);
  for (const g of gattiRemoti.values()) if (g.gatto && g.gatto.gruppo) _proiettanoC.add(g.gatto.gruppo);
  for (const e of ecs.ognuna('vista')) {
    const v = ecs.leggi(e, 'vista');
    if (v && v.mesh) _proiettanoC.add(v.mesh);
  }
  return _proiettanoC;
}
const _proiettanoC = new Set();

function giraCorpi() {
  if (!_corpiOn) { impostaCorpi(null, null, { attiva: false }); return; }
  const dir = uniformiCondivise().uSoleDir.value;
  // ⚠ IL RIQUADRO SEGUE IL GIOCATORE E NON LA CAMERA, e non è la stessa cosa:
  // i corpi stanno dove sta lui, e un riquadro legato allo zoom diventerebbe
  // enorme (e i texel grossi) proprio quando ci si allontana — cioè quando i
  // corpi sono piccoli a schermo e l'ombra conta di più, non di meno.
  corpi.chiave = '';                       // rifare, sempre
  const rifatta = corpi.inquadra({
    dir, bersaglio: controller.pos, raggio: _confCorpi.raggio,
    quotaMin: -6, quotaMax: 24,
  });
  if (rifatta) {
    corpi.costruisci(rig.scena, () => {
      _nascostiCorpi.length = 0;
      const dentro = proiettanoCorpi();
      for (const c of rig.scena.children) {
        if (c.visible && !dentro.has(c)) { c.visible = false; _nascostiCorpi.push(c); }
      }
      // i corpi vivi non hanno vento: un override piatto va bene per tutti
      rig.scena.overrideMaterial = materialeOmbra(false);
    }, () => {
      rig.scena.overrideMaterial = null;
      for (const c of _nascostiCorpi) c.visible = true;
      _nascostiCorpi.length = 0;
    });
  }
  const prof = Math.max(1, corpi.camera.far - corpi.camera.near);
  impostaCorpi(corpi.texture, corpi.matrice, {
    scarto: Math.max(1e-4, _scartoBlocchi / prof), texel: corpi.texel, attiva: true,
    invN: 1 / corpi.N, raggio: _bordiMorbidi ? RAGGIO_OMBRA_MORBIDO : RAGGIO_OMBRA_MINIMO,
  });
}

/** Accende o spegne la mappa dei corpi. ⚠ E SPEGNE I CONI quando la accende:
 *  due sistemi che disegnano la stessa ombra la disegnano DUE VOLTE, e il
 *  risultato è un corpo più scuro di qualunque altra ombra del gioco. */
function corpiOmbra(on) {
  _corpiOn = on === undefined ? !_corpiOn : !!on;
  impostaProfiloShader({ corpi: _corpiOn });
  applicaQualita();               // rifà il bisturi uParti (i coni)
  return _corpiOn;
}
 ...
 *  sole, e un gatto dentro una mappa cachata lascerebbe la sua ombra incollata
 *  dov'era. I corpi vivi continuano a usare i coni uPg finché il §14.9 non li
 *  sposta in una mappa loro. */
// ═══ IL PRIMO DISEGNO DELLA GEOMETRIA NUOVA, pagato quando fa comodo ═══
//
// ⚠ È LA CAUSA DEGLI SCATTI, e ci sono volute quattro misure sbagliate per
// trovarla. Il sospettato ovvio era il MESHER — quello che costruisce i chunk —
// e col cronometro per voce costa **un decimo di millisecondo**. Il picco vero
// stava su `disegno` e `riflesso`: 230 e 240 MILLISECONDI, e solo nei primi
// fotogrammi dopo che il mondo era cambiato.
//
// Perché lì: three carica i buffer in GPU alla PRIMA DRAW, non quando il
// BufferGeometry nasce. Quindi il mesher può avere tutta la sua coda a
// bilancio — e ce l'ha — mentre il conto vero arriva dopo, addosso al render,
// dove nessun bilancio lo guarda. Ed è per questo che si sente «muovendosi» e
// «ruotando la telecamera»: sono i due modi di portare in vista un chunk che
// non è mai stato disegnato.
//
// LA CURA: disegnarli PRIMA, in un bersaglio da UN PIXEL. Il caricamento è lo
...
const _nascostiOmbra = [];
const _proiettano = new Set();

/**
 * CHI PROIETTA È UN ELENCO, non «tutto meno le tre cose che mi sono ricordato».
 *
 * ⚠ QUESTA È UNA CORREZIONE DI POLARITÀ, ed è la stessa lezione della chiave
 * mancante nella scala di qualità: quando il DEFAULT è «sì», ogni modulo nuovo
 * entra nella mappa d'ombra senza che nessuno l'abbia deciso, e non lo dice
 * nessun errore. Il committente l'ha trovato guardando (27/08): «anche la
 * preview di dove posiziono l'oggetto fa ombra il che è strano — anche le
 * farfalle fanno ombra, ma secondo me è un errore che appesantisce e basta».
 * Aveva ragione su tutt'e due, e l'elenco vero era più lungo di così: nella
 * mappa finivano anche la CUPOLA DEL CIELO, le nuvole, la pioggia, le
 * particelle, le lucciole, i fuochi fatui, la crepa dello scavo, i cartelli del
 * percorso e i gatti degli ALTRI giocatori. Il fantasma di piazzamento poi ci
 * entrava per una via tutta sua: è `transparent` con `depthWrite:false`, ma
 * `overrideMaterial` sostituisce il materiale INTERO — trasparenza compresa —
 * quindi in mappa tornava un blocco pieno.
 *
 * Adesso proietta solo chi è in questo elenco. Un modulo nuovo che si aggiunge
 * alla scena NON proietta finché qualcuno non lo scrive qui, che è il verso
 * giusto: l'ombra di troppo è muta, l'ombra che manca si vede.
 */
function proiettanoOmbra(soloMobili) {
  _proiettano.clear();
  // i MOBILI sempre: sono l'unica cosa che la marcia dei voxel non conosce
  // (alberi, lampioni, panchine non sono blocchi della griglia).
  if (arredo.radice) _proiettano.add(arredo.radice);
  // il TERRENO solo in modo «controluce»: con la marcia lo fa la griglia, meglio
  // e senza il reticolo — ed è anche la cura all'acne, che nasceva dalle pareti
  // del terreno che competevano con sé stesse.
  if (!soloMobili) {
    for (const [, e] of mesher.chunks) {
      if (e.solidi) _proiettano.add(e.solidi);
      if (e.acqua) _proiettano.add(e.acqua);
    }
  }
  return _proiettano;
}

function giraControluce() {
  // ⚠ PRIMA DI TUTTO: la mappa è ancora della misura giusta per questo schermo?
  // Non è una domanda oziosa — vedi `adeguaControluce`. Costa un confronto di
  // interi per fotogramma e copre tutt'e tre i modi in cui l'altezza cambia:
  // la finestra ridimensionata, la scala di qualità che scende, e la tela che
  // al primo fotogramma non era ancora stata dimensionata.
  adeguaControluce();
  // ⚠ LA MAPPA SERVE ANCHE ALLA MARCIA, e con dentro una cosa diversa. In modo
  // «controluce» contiene TUTTO; in modo «marcia» contiene i SOLI MOBILI —
  // perché la griglia dei voxel conosce i blocchi e basta, e senza la mappa gli
  // alberi smettono di proiettare. E con il terreno fuori sparisce anche l'acne
  // di Controluce, che nasceva proprio dalle pareti del terreno che competevano
  // con sé stesse.
  const soloMobili = _sistemaOmbra === 'marcia';
  if (!_controluceOn && !soloMobili) { impostaControluce(null, null, { attiva: false }); return; }
  const dir = uniformiCondivise().uSoleDir.value;
  const rifatta = controluce.inquadra({
    dir, bersaglio: rig.bersaglio,
    raggio: _confControluce.k * rig.distanza,
    quotaMin: -8, quotaMax: 48,
    versioneCielo: cieloSorgente().versioneCielo | 0, versioneArredo: arredo.versione | 0,
  });
  if (rifatta) {
    controluce.costruisci(rig.scena, () => {
      _nascostiOmbra.length = 0;
      // ⚠ SI SPEGNE TUTTO QUELLO CHE NON È NELL'ELENCO, e si spegne alla RADICE:
      // `visible = false` su un figlio della scena taglia via l'intero sottoalbero
      // in `projectObject`, quindi una farfalla non costa nemmeno la visita.
      const proiettano = proiettanoOmbra(soloMobili);
      for (const c of rig.scena.children) {
        if (c.visible && !proiettano.has(c)) { c.visible = false; _nascostiOmbra.push(c); }
      }
      if (soloMobili) {
  ...
  // ═════ LO SCARTO SI MISURA IN BLOCCHI, ed è LA manopola di questo sistema.
  //
  // ⚠ E QUI C'ERA UN FRAINTENDIMENTO MIO, chiarito dal committente il 27/08.
  // Con la mappa, una parete girata dal sole si SCURISCE — è la verità
  // geometrica: il sole non ci arriva. Io l'avevo letta come «è tornato il face
  // shading che è stato bocciato», e avevo alzato lo scarto a un blocco e mezzo
  // per farla tornare chiara, pagandolo con l'ombra staccata dalla base.
  // Non era quello il divieto. Le sue parole: «mi va bene che le facce siano in
  // ombra ... semplicemente non voglio il face shading di minecraft che rende i
  // blocchi a 6 sfumature sporche e scurite».
  // La differenza è tutta qui, e va tenuta a mente da chi tocca questa riga:
  // il divieto è su un MOLTIPLICATORE FISSO PER ORIENTAMENTO — sei tinte cotte,
  // sempre uguali, che sporcano il colore. Quello che la mappa fa è un'altra
  // cosa: è BINARIO, prende la TINTA DEL CIELO come ogni altra ombra portata, e
  // soprattutto SI MUOVE — la stessa parete si accende quando il sole gira.
  // Quindi lo scarto torna piccolo: serve solo contro l'acne.
  const _profondita = Math.max(1, controluce.camera.far - controluce.camera.near);
  const scarto = Math.max(1e-4, _scartoBlocchi / _profondita);
  impostaControluce(controluce.texture, controluce.matrice,
    // ⚠ `invN` a ZERO spegne il filtro: `ombraDelSole` ricade su una presa sola.
    // Un interruttore che passa da un numero, invece che da un ramo in più nello
    // shader — il ramo costerebbe sui registri anche da spento (è la lezione già
    // scritta per il profilo).
    // ⚠ `invN` ADESSO C'È SEMPRE, e la manopola è il RAGGIO. Prima l'interruttore
    // dei bordi morbidi passava da `invN = 0`, cioè spegneva il filtro e
    // rimetteva la SCALINATA — che è il difetto che il committente non vuole
    // vedere a nessun costo («né pixel né triangoli»). Adesso il gradino più
    // basso è quattro prese su un texel, non una presa sola: la scalinata non
    // torna mai, cambia solo quanto è morbido.
    { scarto, texel: controluce.texel, attiva: true, invN: 1 / controluce.N,
      raggio: _bordiMorbidi ? RAGGIO_OMBRA_MORBIDO : RAGGIO_OMBRA_MINIMO });
}

/** Cicla i tre sistemi, o ne impone uno. Rende il nome di quello attivo. */
function sistemaOmbra(quale) {
  if (quale === undefined) {
    quale = SISTEMI_OMBRA[(SISTEMI_OMBRA.indexOf(_sistemaOmbra) + 1) % SISTEMI_OMBRA.length];
  }
  _sistemaOmbra = quale;
  _controluceOn = quale === 'controluce';
  // ⚠ I DUE ASSI SI SCRIVONO INSIEME, in una chiamata sola: scritti in due
  // chiamate, la prima ricompila tutti i materiali per uno stato intermedio che
  // non esiste (marcia E controluce accesi, o nessuno dei due) — e ricompilare
  // il programma del mondo due volte si vede come uno scatto.
  impostaProfiloShader({ controluce: _controluceOn, marcia: quale === 'marcia' });
  // ⚠ E L'ERBA VA AVVISATA: col terreno dentro la mappa la heightmap è di
  // troppo, e sommarla darebbe due ombre dello stesso terreno con due bordi
  // diversi — il prato più scuro del blocco che ha sotto.
  uniformiCondivise().uErbaCampo.value = _controluceOn ? 0 : 1;
  controluce.chiave = '';
  // ⚠ LA MAPPA SI SPEGNE SOLO NEL MODO «campo». In «marcia» serve ancora, con
  // dentro i soli mobili: spegnerla qui faceva sparire le ombre degli alberi —
  // che è esattamente il difetto che l'ibrido cura.
  if (quale === 'campo') impostaControluce(null, null, { attiva: false });
  return _sistemaOmbra;
}
impostaCampoSole(campoSole.texture);
campoSole.filtroLineare(!!rig.renderer.extensions.get('OES_texture_float_linear'));
// ⚠ E IL PROFILO VA SCRITTO DAVVERO, non solo la variabile: `_profilo.controluce`
// nasce a false dentro materials.js, e senza questa riga il flag qui sopra
// direbbe «acceso» mentre lo shader compilato non contiene il ramo. È
// letteralmente il difetto storico del §1.3 — una uniform giusta che non prova
// niente perché il programma non la legge.
sistemaOmbra(_sistemaOmbra);
...
/** Quanto si aspetta prima di RIPROVARE un gradino che non aveva retto. Un
 *  minuto: abbastanza perché la scena sia cambiata davvero, poco abbastanza da
 *  non restare in basso per tutta la partita se il calo era un momento. */
const RIPROVA_MS = 60000;
let _livelloFallito = -1;
let _quandoFallito = 0;
let _giu = 0, _su = 0, _ultimoCambio = 0;

/**
 * LE SOGLIE SI MISURANO SUL TETTO DELLO SCHERMO, non su 60.
 *
 * ⚠ QUESTO È IL DIFETTO CHE HA TENUTO UN CHROMEBOOK INCHIODATO IN FONDO ALLA
 * SCALA. La soglia per RISALIRE era `fps >= 58`, scritta pensando «60 Hz meno
 * due di margine». Ma con la sincronia verticale un pannello a 60 Hz non dà mai
 * 60 tondi: fra un fotogramma perso e l'arrotondamento del contatore si sta
 * quasi sempre a 57-59. Quindi la condizione per risalire NON SI VERIFICAVA MAI,
 * e la scala aveva una sola direzione: giù. Il committente l'ha detto meglio di
 * me: «su Chromebook è tutto loccato e basso, non è che hai preso alla lettera i
 * 60 fps?». Sì, letteralmente.
 *
 * ⚠ E NON BASTA ABBASSARE 58 A 55: su un pannello a 144 Hz «55 fps» vuol dire
 * che si sta soffrendo, e la scala salirebbe proprio mentre andrebbe scesa. La
 * soglia non è un numero, è una FRAZIONE del tetto — che adesso si misura
 * (`stimaRefresh`) invece di darlo per scontato.
 *
 * Si risale al 90% del tetto: vuol dire «stiamo al passo dello schermo, proviamo
 * a chiedere di più». Si scende sotto il 45% del tetto, ma mai pretendendo più
 * di 45 fps: su un 144 Hz, 60 fps stabili non sono un problema da curare
 * togliendo qualità.
 */
/**
 * ⚠⚠ IL BERSAGLIO È SESSANTA, NON IL REFRESH — e questa riga è la correzione di
 * un mio errore che ha peggiorato le cose invece di curarle.
 *
 * La prima versione misurava le soglie sul TETTO DELLO SCHERMO: si risaliva al
 * 90% del tetto. Su un 60 Hz è giusto e cura il Chromebook. Su un 144 Hz vuol
 * dire **risalire solo sopra i 130 fps**, mentre prima bastavano 58: ho reso
 * la salita MOLTO più difficile proprio dove prima funzionava. E insieme ho
 * abbassato la soglia di discesa a 45 (era 28), cioè l'ho resa più facile.
 * Giù in fretta e mai più su.
 *
 * Il conto di cosa costa: sotto il QUARTO gradino della scala desktop
 * `campioni` va a 0, cioè si spegne l'MSAA. Il committente l'ha visto così:
 * «tutto seghettato» — non le ombre, TUTTO, perché sono i bordi della
 * geometria. Più la scala di resa che scende a 0,62.
 *
 * La verità è che il tetto dello schermo NON è il bersaglio: è solo un
 * COPERCHIO. Il bersaglio è avere sessanta fotogrammi stabili — sopra quelli, i
 * fotogrammi in più valgono meno della qualità. Quindi si punta a
 * `min(tetto, 60)`: su un 60 Hz è il tetto (e la soglia di salita a 55 evita la
 * trappola del «58 che con la sincronia verticale non arriva mai»), su un
 * 144 Hz è 60 — e a 100 fps si RISALE, invece di restare inchiodati in fondo.
 */
function bersaglioFps() { return Math.min(_refreshHz > 0 ? _refreshHz : 60, 60); }
function sogliaSu() { return bersaglioFps() * 0.92; }
function sogliaGiu() { return Math.max(24, bersaglioFps() * 0.5); }
...
function adattaQualita(fps) {
  ...
  if (fps < sogliaGiu()) { _giu++; _su = 0; }
  else if (fps >= sogliaSu()) { _su++; _giu = 0; }
  else { _giu = 0; _su = 0; }

  if (_giu >= CAMPIONI_GIU && qLivello < LIVELLI_Q.length - 1) {
    // ⚠ SI RICORDA QUALE GRADINO NON HA RETTO. Senza, la scala oscilla: si
    // risale al 90% del tetto, il gradino di sopra non regge, si riscende, e
    // quattro secondi dopo si riprova — un su-e-giù ogni otto secondi, che a
    // schermo è la qualità che sfarfalla. È il difetto che nasce insieme alla
    // cura: prima non risaliva MAI, e un difetto che non si vede è quello che
    // sostituisce quello che si vede.
    _livelloFallito = qLivello; _quandoFallito = adesso;
    qLivello++; _giu = _su = 0; _ultimoCambio = adesso; applicaQualita();
  } else if (_su >= CAMPIONI_SU && qLivello > 0) {
    // il gradino che ha già fallito si riprova, ma dopo un minuto: la scena può
    // essere cambiata (si è usciti dal bosco, la pioggia è finita) e allora
    // vale la pena, mentre riprovarlo subito è solo l'oscillazione.
    if (qLivello - 1 === _livelloFallito && adesso - _quandoFallito < RIPROVA_MS) { _su = 0; return; }
    qLivello--; _giu = _su = 0; _ultimoCambio = adesso; applicaQualita();
  }
}
...
function passo(adesso, frameXR) {
  ...
  crono('controller', () => controller.aggiorna(dt));
  crono('audio', () => audio.aggiorna(dt, ciclo.eNotte ? 1 : 0));
  ...
  if (!modalitaAR.attiva && !modalitaXR.attiva) {
    ...
    crono('creature', () => creature.sincronizza(ecs, servizi, controller.pos));
    ...
    crono('fatui', () => fuochiFatui.aggiorna(dt, controller.pos));
  }
  ...
  crono('gatto', () => gatto.aggiorna(dt, controller.pos, _vx, _vz, controller.aTerra || controller.inAcqua));
  ...
  crono('calpesta', () => calpestaFoglie());
  crono('materialeMondo', () => mesher.aggiornaMaterialeMondo());   // opaco quando il buco è chiuso: early-z
  ...
  crono('sagome', () => impostaOmbre(scatoleVertice(), _ombrePg));
  // ⚠ CONTROLUCE PRIMA DEL RIFLESSO, e non è un dettaglio d'ordine: il riflesso
  // planare ri-renderizza la scena specchiata e legge la mappa com'è adesso.
  // Aggiornarla dopo gli farebbe mostrare l'ombra di un fotogramma fa — con il
  // bordo sfocato di prima non si vedeva, con un bordo netto sì.
  crono('controluce', () => giraControluce());
  crono('corpi', () => giraCorpi());
  crono('campo', () => campoSole.aggiorna({
    ...cieloSorgente(),
    dir: uniformiCondivise().uSoleDir.value,
    scatole: scatoleCampo(),
    versioneScatole: arredo.versione,
    // ⚠ SOLO SE È LUI IL SISTEMA ATTIVO. Il campo ricalcola a fette dentro un
    // bilancio di 2 ms PER FOTOGRAMMA, e con la marcia o Controluce accesi non
    // lo legge nessuno: erano due millisecondi di CPU regalati, su una macchina
    // misurata a 12,9 ms di CPU con 8,3 di budget. Il campo resta vivo come
    // termine di paragone — si riaccende da solo quando lo si sceglie dal
    // bottone 🌓, perché la sua chiave riparte da capo.
    attivo: passiCielo() > 0 && _sistemaOmbra === 'campo',
  }));
  ...
  if (contTempo >= 0.5) {
    ...
    // ⚠ IL LAVORO ACCANTO AGLI FPS, e solo col misuratore acceso (G) perché è
    // l'unico momento in cui il numero della GPU esiste davvero. Senza, «123
    // fps» è ambiguo: in un browser rAF non supera la frequenza dello schermo,
