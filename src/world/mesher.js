...
import { BLOCCHI, defDi, tipoBase, livelloAcqua } from './blocks.js?v=ms2y1d0v';
import { paletteBlocco, coloreFaccia } from './stagioni.js?v=ms2y1d0v';
import { FORME_EXTRA, FORME_VUOTE } from './forme.js?v=ms2y1d0v';
import { tintaPalette } from './motivi.js?v=ms2y1d0v';
import { GrigliaLuce, scatolaPerMondo } from './luce.js?v=ms2y1d0v';
import { materialeMondo, materialeAcqua, aggiornaCielo, impostaVoxel, spegniVoxel, latoMassimoVoxel } from '../fx/materials.js?v=ms2y1d0v';
import { CHUNK } from './world.js?v=ms2y1d0v';
