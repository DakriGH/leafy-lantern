...
import { BLOCCHI, defDi, tipoBase, livelloAcqua } from './blocks.js?v=mtaobft4';
import { paletteBlocco, coloreFaccia } from './stagioni.js?v=mtaobft4';
import { FORME_EXTRA, FORME_VUOTE } from './forme.js?v=mtaobft4';
import { tintaPalette } from './motivi.js?v=mtaobft4';
import { GrigliaLuce, scatolaPerMondo } from './luce.js?v=mtaobft4';
import { materialeMondo, materialeAcqua, aggiornaCielo, impostaVoxel, spegniVoxel, latoMassimoVoxel, mondoVelato } from '../fx/materials.js?v=mtaobft4';
import { CHUNK } from './world.js?v=mtaobft4';
