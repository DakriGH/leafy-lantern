...
import { BLOCCHI, defDi, tipoBase, livelloAcqua } from './blocks.js?v=mtbytwog';
import { paletteBlocco, coloreFaccia } from './stagioni.js?v=mtbytwog';
import { materiaDi, tingiMateria } from './materie.js?v=mtbytwog';
import { FORME_EXTRA, FORME_VUOTE } from './forme.js?v=mtbytwog';
import { tintaPalette } from './motivi.js?v=mtbytwog';
import { GrigliaLuce, scatolaPerMondo } from './luce.js?v=mtbytwog';
import { materialeMondo, materialeAcqua, aggiornaCielo, impostaVoxel, spegniVoxel, latoMassimoVoxel, mondoVelato } from '../fx/materials.js?v=mtbytwog';
import { CHUNK } from './world.js?v=mtbytwog';
