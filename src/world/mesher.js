...
import { BLOCCHI, defDi, tipoBase, livelloAcqua } from './blocks.js?v=ms9b0zbn';
import { paletteBlocco, coloreFaccia } from './stagioni.js?v=ms9b0zbn';
import { FORME_EXTRA, FORME_VUOTE } from './forme.js?v=ms9b0zbn';
import { tintaPalette } from './motivi.js?v=ms9b0zbn';
import { GrigliaLuce, scatolaPerMondo } from './luce.js?v=ms9b0zbn';
import { materialeMondo, materialeAcqua, aggiornaCielo, impostaVoxel, spegniVoxel, latoMassimoVoxel, mondoVelato } from '../fx/materials.js?v=ms9b0zbn';
import { CHUNK } from './world.js?v=ms9b0zbn';
