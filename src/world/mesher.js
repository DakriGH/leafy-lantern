...
import { BLOCCHI, defDi, tipoBase, livelloAcqua } from './blocks.js?v=mrt21mqg';
import { paletteBlocco, coloreFaccia } from './stagioni.js?v=mrt21mqg';
import { FORME_EXTRA, FORME_VUOTE } from './forme.js?v=mrt21mqg';
import { tintaPalette } from './motivi.js?v=mrt21mqg';
import { GrigliaLuce, scatolaPerMondo } from './luce.js?v=mrt21mqg';
import { materialeMondo, materialeAcqua, aggiornaCielo, impostaVoxel, spegniVoxel, latoMassimoVoxel } from '../fx/materials.js?v=mrt21mqg';
import { CHUNK } from './world.js?v=mrt21mqg';
