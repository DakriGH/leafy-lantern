...
import { BLOCCHI, defDi, tipoBase, livelloAcqua } from './blocks.js?v=mrt4nxiv';
import { paletteBlocco, coloreFaccia } from './stagioni.js?v=mrt4nxiv';
import { FORME_EXTRA, FORME_VUOTE } from './forme.js?v=mrt4nxiv';
import { tintaPalette } from './motivi.js?v=mrt4nxiv';
import { GrigliaLuce, scatolaPerMondo } from './luce.js?v=mrt4nxiv';
import { materialeMondo, materialeAcqua, aggiornaCielo, impostaVoxel, spegniVoxel, latoMassimoVoxel } from '../fx/materials.js?v=mrt4nxiv';
import { CHUNK } from './world.js?v=mrt4nxiv';
