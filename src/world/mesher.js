...
import { BLOCCHI, defDi, tipoBase, livelloAcqua } from './blocks.js?v=mtavac71';
import { paletteBlocco, coloreFaccia } from './stagioni.js?v=mtavac71';
import { FORME_EXTRA, FORME_VUOTE } from './forme.js?v=mtavac71';
import { tintaPalette } from './motivi.js?v=mtavac71';
import { GrigliaLuce, scatolaPerMondo } from './luce.js?v=mtavac71';
import { materialeMondo, materialeAcqua, aggiornaCielo, impostaVoxel, spegniVoxel, latoMassimoVoxel, mondoVelato } from '../fx/materials.js?v=mtavac71';
import { CHUNK } from './world.js?v=mtavac71';
