...
import { BLOCCHI, defDi, tipoBase, livelloAcqua } from './blocks.js?v=mtatdt9r';
import { paletteBlocco, coloreFaccia } from './stagioni.js?v=mtatdt9r';
import { FORME_EXTRA, FORME_VUOTE } from './forme.js?v=mtatdt9r';
import { tintaPalette } from './motivi.js?v=mtatdt9r';
import { GrigliaLuce, scatolaPerMondo } from './luce.js?v=mtatdt9r';
import { materialeMondo, materialeAcqua, aggiornaCielo, impostaVoxel, spegniVoxel, latoMassimoVoxel, mondoVelato } from '../fx/materials.js?v=mtatdt9r';
import { CHUNK } from './world.js?v=mtatdt9r';
