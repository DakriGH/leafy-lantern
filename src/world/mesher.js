...
import { BLOCCHI, defDi, tipoBase, livelloAcqua } from './blocks.js?v=mtbzxc5q';
import { paletteBlocco, coloreFaccia } from './stagioni.js?v=mtbzxc5q';
import { materiaDi, tingiMateria } from './materie.js?v=mtbzxc5q';
import { FORME_EXTRA, FORME_VUOTE } from './forme.js?v=mtbzxc5q';
import { tintaPalette } from './motivi.js?v=mtbzxc5q';
import { GrigliaLuce, scatolaPerMondo } from './luce.js?v=mtbzxc5q';
import { materialeMondo, materialeAcqua, aggiornaCielo, impostaVoxel, spegniVoxel, latoMassimoVoxel, mondoVelato } from '../fx/materials.js?v=mtbzxc5q';
import { CHUNK } from './world.js?v=mtbzxc5q';
