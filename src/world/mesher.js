...
import { BLOCCHI, defDi, tipoBase, livelloAcqua } from './blocks.js?v=mrsi80i0';
import { paletteBlocco, coloreFaccia } from './stagioni.js?v=mrsi80i0';
import { FORME_EXTRA, FORME_VUOTE } from './forme.js?v=mrsi80i0';
import { tintaPalette } from './motivi.js?v=mrsi80i0';
import { GrigliaLuce, scatolaPerMondo } from './luce.js?v=mrsi80i0';
import { materialeMondo, materialeAcqua, aggiornaCielo, impostaVoxel, spegniVoxel, latoMassimoVoxel } from '../fx/materials.js?v=mrsi80i0';
import { CHUNK } from './world.js?v=mrsi80i0';
