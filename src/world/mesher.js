...
import { BLOCCHI, defDi, tipoBase, livelloAcqua } from './blocks.js?v=ms24973m';
import { paletteBlocco, coloreFaccia } from './stagioni.js?v=ms24973m';
import { FORME_EXTRA, FORME_VUOTE } from './forme.js?v=ms24973m';
import { tintaPalette } from './motivi.js?v=ms24973m';
import { GrigliaLuce, scatolaPerMondo } from './luce.js?v=ms24973m';
import { materialeMondo, materialeAcqua, aggiornaCielo, impostaVoxel, spegniVoxel, latoMassimoVoxel } from '../fx/materials.js?v=ms24973m';
import { CHUNK } from './world.js?v=ms24973m';
