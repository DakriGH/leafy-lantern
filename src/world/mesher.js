...
import { BLOCCHI, defDi, tipoBase, livelloAcqua } from './blocks.js?v=mtbggcsp';
import { paletteBlocco, coloreFaccia } from './stagioni.js?v=mtbggcsp';
import { materiaDi, tingiMateria } from './materie.js?v=mtbggcsp';
import { FORME_EXTRA, FORME_VUOTE } from './forme.js?v=mtbggcsp';
import { tintaPalette } from './motivi.js?v=mtbggcsp';
import { GrigliaLuce, scatolaPerMondo } from './luce.js?v=mtbggcsp';
import { materialeMondo, materialeAcqua, aggiornaCielo, impostaVoxel, spegniVoxel, latoMassimoVoxel, mondoVelato } from '../fx/materials.js?v=mtbggcsp';
import { CHUNK } from './world.js?v=mtbggcsp';
