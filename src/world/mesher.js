...
import { BLOCCHI, defDi, tipoBase, livelloAcqua } from './blocks.js?v=mtbqx52f';
import { paletteBlocco, coloreFaccia } from './stagioni.js?v=mtbqx52f';
import { materiaDi, tingiMateria } from './materie.js?v=mtbqx52f';
import { FORME_EXTRA, FORME_VUOTE } from './forme.js?v=mtbqx52f';
import { tintaPalette } from './motivi.js?v=mtbqx52f';
import { GrigliaLuce, scatolaPerMondo } from './luce.js?v=mtbqx52f';
import { materialeMondo, materialeAcqua, aggiornaCielo, impostaVoxel, spegniVoxel, latoMassimoVoxel, mondoVelato } from '../fx/materials.js?v=mtbqx52f';
import { CHUNK } from './world.js?v=mtbqx52f';
