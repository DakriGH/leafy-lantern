...
import { BLOCCHI, defDi, tipoBase, livelloAcqua } from './blocks.js?v=mtaui0h5';
import { paletteBlocco, coloreFaccia } from './stagioni.js?v=mtaui0h5';
import { FORME_EXTRA, FORME_VUOTE } from './forme.js?v=mtaui0h5';
import { tintaPalette } from './motivi.js?v=mtaui0h5';
import { GrigliaLuce, scatolaPerMondo } from './luce.js?v=mtaui0h5';
import { materialeMondo, materialeAcqua, aggiornaCielo, impostaVoxel, spegniVoxel, latoMassimoVoxel, mondoVelato } from '../fx/materials.js?v=mtaui0h5';
import { CHUNK } from './world.js?v=mtaui0h5';
