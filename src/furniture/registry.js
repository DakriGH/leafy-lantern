...
import { creaEntitaPalla, distruggiPalla } from '../gioco/palla.js?v=msaimh0d';
import { svegliaMacchina, impostaConfig } from '../gioco/macchine.js?v=msaimh0d';
import { defDi } from '../world/blocks.js?v=msaimh0d';
