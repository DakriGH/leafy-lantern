...
import { PX } from '../config.js?v=mtbh33f2';
import { FURNI, celleOccupate, celleAppoggio, centroide } from './registry.js?v=mtbh33f2';
import { defDi } from '../world/blocks.js?v=mtbh33f2';
import { creaLuce, rimuoviLuce } from '../fx/materials.js?v=mtbh33f2';
