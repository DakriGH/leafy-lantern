...
import { PX } from '../config.js?v=ms2y1d0v';
import { FURNI, celleOccupate, celleAppoggio, centroide } from './registry.js?v=ms2y1d0v';
import { defDi } from '../world/blocks.js?v=ms2y1d0v';
import { creaLuce, rimuoviLuce } from '../fx/materials.js?v=ms2y1d0v';
