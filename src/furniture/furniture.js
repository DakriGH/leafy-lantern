...
import { PX } from '../config.js?v=ms8pty9a';
import { FURNI, celleOccupate, celleAppoggio, centroide } from './registry.js?v=ms8pty9a';
import { defDi } from '../world/blocks.js?v=ms8pty9a';
import { creaLuce, rimuoviLuce } from '../fx/materials.js?v=ms8pty9a';
