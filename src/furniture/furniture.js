...
import { PX } from '../config.js?v=ms8osh8u';
import { FURNI, celleOccupate, celleAppoggio, centroide } from './registry.js?v=ms8osh8u';
import { defDi } from '../world/blocks.js?v=ms8osh8u';
import { creaLuce, rimuoviLuce } from '../fx/materials.js?v=ms8osh8u';
