...
import { PX } from '../config.js?v=ms9akp2m';
import { FURNI, celleOccupate, celleAppoggio, centroide } from './registry.js?v=ms9akp2m';
import { defDi } from '../world/blocks.js?v=ms9akp2m';
import { creaLuce, rimuoviLuce } from '../fx/materials.js?v=ms9akp2m';
