...
import { PX } from '../config.js?v=ms2yheag';
import { FURNI, celleOccupate, celleAppoggio, centroide } from './registry.js?v=ms2yheag';
import { defDi } from '../world/blocks.js?v=ms2yheag';
import { creaLuce, rimuoviLuce } from '../fx/materials.js?v=ms2yheag';
