...
import { PX } from '../config.js?v=ms7zdnfp';
import { FURNI, celleOccupate, celleAppoggio, centroide } from './registry.js?v=ms7zdnfp';
import { defDi } from '../world/blocks.js?v=ms7zdnfp';
import { creaLuce, rimuoviLuce } from '../fx/materials.js?v=ms7zdnfp';
