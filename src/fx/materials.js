...
import { LUCI_MAX, BANDE_LUCE } from '../config.js?v=mtbh33f2';
import { glslControluce } from './controluce.js?v=mtbh33f2';
import { PASSI_MAX, SCARTO_OMBRA } from '../world/luce.js?v=mtbh33f2';
