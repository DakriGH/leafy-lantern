...
import { LUCI_MAX, BANDE_LUCE } from '../config.js?v=mtatt887';
import { glslControluce } from './controluce.js?v=mtatt887';
import { PASSI_MAX, SCARTO_OMBRA } from '../world/luce.js?v=mtatt887';
