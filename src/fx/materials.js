...
import { LUCI_MAX, BANDE_LUCE } from '../config.js?v=mtavh9vl';
import { glslControluce } from './controluce.js?v=mtavh9vl';
import { PASSI_MAX, SCARTO_OMBRA } from '../world/luce.js?v=mtavh9vl';
