...
import { LUCI_MAX, BANDE_LUCE } from '../config.js?v=mtatm933';
import { glslControluce } from './controluce.js?v=mtatm933';
import { PASSI_MAX, SCARTO_OMBRA } from '../world/luce.js?v=mtatm933';
