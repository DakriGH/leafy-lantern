...
import { paletteBlocco } from '../world/stagioni.js?v=msaimh0d';
import { CHUNK } from '../world/world.js?v=msaimh0d';
import { uniformiOmbraSole, uniformiScatole, uniformiLuci, GLSL_SCATOLE_VERTICE, GLSL_LUCI_VERTICE } from './materials.js?v=msaimh0d';
