...
import { paletteBlocco } from '../world/stagioni.js?v=msalm33s';
import { CHUNK } from '../world/world.js?v=msalm33s';
import { uniformiOmbraSole, uniformiScatole, uniformiLuci, GLSL_SCATOLE_VERTICE, GLSL_LUCI_VERTICE } from './materials.js?v=msalm33s';
