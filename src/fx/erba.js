...
import { paletteBlocco } from '../world/stagioni.js?v=msakthua';
import { CHUNK } from '../world/world.js?v=msakthua';
import { uniformiOmbraSole, uniformiScatole, uniformiLuci, GLSL_SCATOLE_VERTICE, GLSL_LUCI_VERTICE } from './materials.js?v=msakthua';
