...
import { paletteBlocco } from '../world/stagioni.js?v=mtbg4x74';
import { CHUNK } from '../world/world.js?v=mtbg4x74';
import { uniformiOmbraSole, uniformiScatole, uniformiLuci, GLSL_SCATOLE_VERTICE, GLSL_LUCI_VERTICE, GBANDE } from './materials.js?v=mtbg4x74';
