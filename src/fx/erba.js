...
import { paletteBlocco } from '../world/stagioni.js?v=mtbh8fyh';
import { CHUNK } from '../world/world.js?v=mtbh8fyh';
import { uniformiOmbraSole, uniformiScatole, uniformiLuci, GLSL_SCATOLE_VERTICE, GLSL_LUCI_VERTICE, GBANDE } from './materials.js?v=mtbh8fyh';
