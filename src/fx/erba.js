...
import { paletteBlocco } from '../world/stagioni.js?v=mtbifcbo';
import { CHUNK } from '../world/world.js?v=mtbifcbo';
import { uniformiOmbraSole, uniformiScatole, uniformiLuci, GLSL_SCATOLE_VERTICE, GLSL_LUCI_VERTICE, GBANDE } from './materials.js?v=mtbifcbo';
